...
public class ChipsInput extends ScrollViewMaxHeight {
    ...
    private void init(AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            try {
                ...
                mHintTextSize = a.getDimensionPixelSize(R.styleable.ChipsInput_hintSize, 0);
    ...
    public void addChip(Object id, String iconUrl, String label, String info) {
        Chip chip = new Chip(id, iconUrl, label, info);
        mChipsAdapter.addChip(chip);
    }
    ...
    public ChipsInputEditText getEditText() {
        ...
        if (mHintTextSize >= 0)
            //convert the sp size to px and set the hint txt size
            editText.setTextSize(TypedValue.COMPLEX_UNIT_PX, mHintTextSize);
        if(mHintColor != null)
