...
public class ContactChipActivity extends AppCompatActivity {

    private static final String TAG = ContactChipActivity.class.toString();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contact_chip);
//        LocaleHelper.setLocale(this, "iw");
        ...
        new RxPermissions(this)
                ...
                .subscribe(granted -> {
                    ...
                    Toast.makeText(ContactChipActivity.this, "Error get contacts, see logs", Toast.LENGTH_LONG).show();
                });
        ...
        mChipsInput.addChipsListener(new ChipsInput.ChipsListener() {
            ...
            public void onChipAdded(ChipInterface chip, int newSize) {
                ...
                mChipsInput.addChip(chip.getId(), chip.getAvatarUri(),"test", chip.getInfo());
            }
